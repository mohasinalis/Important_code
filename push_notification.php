...
class push_notification extends CI_Controller {
    ...
    public function send_notification_to_ios($registatoin_ids) {
        ...
        //stream_context_set_option($ctx, 'ssl', 'local_cert', '/var/www/html/project/assets/JOSNewBuild_sandbox.pem');  // for staging
        stream_context_set_option($ctx, 'ssl', 'local_cert', 'D:\xampp\htdocs\project\assets\JOSNewBuild_sandbox.pem'); // For local
